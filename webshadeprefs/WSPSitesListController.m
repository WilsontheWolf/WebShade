// #include "WSPSitesListController.h"

// @implementation WSPSitesListController

// - (NSArray *)specifiers {
// 	if (!_specifiers) {
// 		_specifiers = [self loadSpecifiersFromPlistName:@"Sites" target:self];
// 	}
...
// Special thanks to @LacertosusRepo @denialpan @AzzouDuGhetto for this
...
@implementation WSPSitesListController
	-(id)init {
		...
		if(self) {
			...
			HBPreferences *preferences = [HBPreferences preferencesForIdentifier:@"com.wilsonthewolf.webshadeprefs"];
	...
	-(void)viewDidAppear:(BOOL)animated {
		...
		title.text = @"Igore me incomplete";
